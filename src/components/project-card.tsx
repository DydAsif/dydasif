    ...
    <>
      ...
      >
        <div className="grid md:grid-cols-2 items-stretch">
          ...
          <div className="p-6 lg:p-8 bg-secondary/20 h-full flex flex-col justify-between">
            <Tabs defaultValue="problem" onValueChange={(value) => setActiveTab(value as TabValue)} className="w-full">
              ...
              {TABS.map(tab => (
                <TabsContent key={tab.value} value={tab.value}>
                  <div 
                    className="relative mt-4 aspect-video rounded-lg overflow-hidden border-2 border-border/50 group cursor-pointer"
