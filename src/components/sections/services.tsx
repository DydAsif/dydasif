...
const StapeLogo = () => (
    ...
    >
        <g>
            <path d="M197.3 42.7H74.7V105.2L116.2 128L74.7 150.8V213.3H197.3V42.7Z" fill="#F96738"/>
            <path d="M174.4,177.1c-5.9,4.8-13.7,7.2-23.4,7.2c-11.1,0-19.8-3.1-26.2-9.4c-6.4-6.3-9.6-15-9.6-26.1c0-11.1,3.2-19.8,9.7-26.1c6.5-6.3,15.2-9.4,26.1-9.4c9.1,0,16.3,2.1,21.8,6.4V100c-6.3-3-13.7-4.5-22.1-4.5c-16.5,0-29.1,5.3-37.7,16c-8.6,10.7-13,24-13,39.8c0,16.1,4.4,29.5,13.1,40.3c8.8,10.8,21.4,16.1,37.8,16.1c8.4,0,16-1.5,22.7-4.7V177.1H174.4z" fill="#1D1D1B"/>
        </g>
    </svg>
);
