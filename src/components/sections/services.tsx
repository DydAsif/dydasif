...
const StapeLogo = () => (
    ...
    >
      <path fill="#F97316" d="M19.467 0H0v32h19.467L9.733 16z"/>
      <path fill="#231F20" d="M25.751 14.887c0-.974-.195-1.82-.586-2.54s-.928-1.307-1.612-1.787c-.684-.48-1.504-.72-2.461-.72c-1.109 0-2.077.313-2.904.94c-.827.626-1.405 1.473-1.736 2.54l1.696.72c.146-.46.376-.833.688-1.12s.661-.494 1.056-.627c.395-.133.79-.2 1.184-.2c.604 0 1.107.167 1.508.5s.602.807.602 1.407c0 .367-.073.687-.22.96c-.146.273-.354.52-.62.74l-2.096 1.76c-.725.607-1.217 1.307-1.474 2.1s-.386 1.653-.386 2.56v.053c0 .973.195 1.82.586 2.54s.928 1.306 1.612 1.786c.684.48 1.504.72 2.461.72c1.035 0 1.96-.307 2.776-.92c.816-.613 1.375-1.433 1.676-2.48l-1.696-.72c-.146.467-.375.84-.687 1.127c-.312.287-.665.493-1.06.626c-.395.134-.789.2-1.184.2c-.604 0-1.107-.167-1.508-.5s-.602-.807-.602-1.407v-.053c0-.367.073.687-.22.96c-.146.273.354-.52.62-.74l2.096-1.76c.725-.607 1.217-1.307 1.474-2.1c.257-.793.386-1.647.386-2.56v.054z"/>
    </svg>
);
