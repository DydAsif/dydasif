...
const StapeSIcon = () => (
    ...
    >
      <path d="M26.9,0H5.1L10,30.5L5.1,61h21.7L31.8,30.5L26.9,0z M55,14.2c-4.4-4-10-4.6-15-1.5c-2,1.2-3.4,3.1-4.2,5.2  c-1.1,3-1,6.3,0.4,9.1c1.5,3,4,5.2,7,6.5l3,1.3c2.7,1.2,4.6,3.6,5.1,6.5c0.5,3.2-0.5,6.5-2.8,8.8c-2.3,2.3-5.6,3.4-8.8,2.8  c-3.2-0.5-6-2.6-7.6-5.4l-0.7-1.3c-0.6-1.1-1.8-1.5-2.9-0.9c-1.1,0.6-1.5,1.8-0.9,2.9l0.7,1.3c2.2,4,5.9,6.9,10.3,7.9  c5.2,1.2,10.7-0.4,14.6-4.3c3.9-3.9,5.5-9.4,4.3-14.6c-1.2-5.2-4.8-9.5-9.6-12.2l-3-1.3c-2.4-1.1-4-3.2-4.6-5.7  c-0.6-2.8,0.3-5.7,2.2-7.8c1.9-2.1,4.7-3.2,7.5-2.8c2.8,0.4,5.2,2.3,6.5,4.7l0.6,1.2c0.6,1.1,1.8,1.5,2.9,0.9  c1.1-0.6,1.5-1.8,0.9-2.9l-0.6-1.2C59.7,18.8,57.3,16.2,55,14.2z" />
    </svg>
  );
