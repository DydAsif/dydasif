...
const StapeSIcon = () => (
    ...
    >
      <path d="M0 0L24 24L0 48L12 48L36 24L12 0L0 0Z" />
      <path d="M49.5 33.1C47.8 35.1 45.7 36.6 43.1 37.5C40.5 38.4 37.8 38.4 35 37.4C32.2 36.4 29.9 34.8 28.1 32.5C26.3 30.2 25.4 27.5 25.4 24.3C25.4 21 26.3 18.2 28 15.8C29.7 13.4 32 11.6 34.8 10.5C37.6 9.4 40.3 9.4 42.9 10.4C45.5 11.4 47.7 13.1 49.3 15.3L45.7 17.4C44.6 16 43.2 15 41.5 14.4C39.8 13.8 38.1 13.8 36.4 14.4C34.6 15 33.2 16 32.1 17.3C31 18.7 30.5 20.4 30.5 22.4C30.5 24.4 31 26.2 32.1 27.5C33.2 28.8 34.6 29.8 36.4 30.3C38.2 30.9 39.9 30.9 41.6 30.3C43.3 29.7 44.7 28.7 45.8 27.3L49.5 29.4L49.5 33.1Z" />
    </svg>
  );
