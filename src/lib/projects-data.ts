...
export const projects: Project[] = [
  {
    ...
    problem: {
      image: 'https://i.ibb.co/XkYBT9Jf/1prob-ss.jpg',
      imageAlt: 'Facebook Events Manager showing tracking problem',
    ...
    solution: {
        image: 'https://placehold.co/880x450/1d283a/9ca3af?text=Solution',
    ...
    result: {
        image: 'https://placehold.co/880x450/1d283a/9ca3af?text=Result',
  ...
  },
  {
    ...
    problem: {
      image: 'https://placehold.co/880x450/1d283a/9ca3af?text=Problem',
