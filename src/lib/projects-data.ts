...
export const projects: Project[] = [
  {
    ...
    imageUrl: 'https://i.ibb.co/rKWj6Srs/GA4-Google-Ads-e-Commerce-Tracking-2.png',
  ...
  },
  {
    ...
    imageUrl: 'https://i.ibb.co/LTsbR2D/GA4-Google-Ads-e-Commerce-Tracking.png',
    imageAlt: 'GA4 and Google Ads Tracking',
