...
export const projects: Project[] = [
  {
    ...
    problem: {
      image: 'https://i.ibb.co/B2XJ62x6/550-1.png',
      imageAlt: 'Facebook Events Manager showing poor event match quality and deduplication issues.',
    ...
    solution: {
        image: 'https://placehold.co/800x550/1d283a/9ca3af?text=Solution',
    ...
    result: {
        image: 'https://placehold.co/800x550/1d283a/9ca3af?text=Result',
  ...
  },
  {
    ...
    problem: {
      image: 'https://placehold.co/800x550/1d283a/9ca3af?text=Problem',
