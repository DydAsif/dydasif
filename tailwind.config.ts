  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'glow-blue': {
          '0%, 100%': { 'box-shadow': '0 0 5px #00ccff, 0 0 10px #00ccff' },
          '50%': { 'box-shadow': '0 0 20px #4f86f7, 0 0 30px #4f86f7' },
        },
        'glow-green': {
      ...
      animation: {
        ...
        'fade-in-from-right': 'fade-in-from-right 0.5s ease-out forwards',
        'glow-blue': 'glow-blue 1.5s ease-in-out infinite',
